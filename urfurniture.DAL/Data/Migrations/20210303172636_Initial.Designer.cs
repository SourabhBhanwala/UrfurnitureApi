...
namespace urfurniture.DAL.Data.Migrations
{
    ...
    [Migration("20210303172636_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("urfurniture.DAL.Entities.TblDeliverableLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TblDeliverableLocations");
                });
            ...
            modelBuilder.Entity("urfurniture.DAL.Entities.TblOption", b =>
                {
                    ...
                    b.Property<int>("OptionGroupRefId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OptionGroupRefId");

                    b.ToTable("TblOptions");
                });

            modelBuilder.Entity("urfurniture.DAL.Entities.TblOptionGroup", b =>
                {
            ...
            modelBuilder.Entity("urfurniture.DAL.Entities.TblOption", b =>
                {
                    b.HasOne("urfurniture.DAL.Entities.TblOptionGroup", "TblOptionGroup")
                        .WithMany("TblOption")
                        .HasForeignKey("OptionGroupRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TblOptionGroup");
                });
            ...
            modelBuilder.Entity("urfurniture.DAL.Entities.TblProductOption", b =>
                {
                    b.HasOne("urfurniture.DAL.Entities.TblOption", "TblOption")
